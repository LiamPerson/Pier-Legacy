        ...
        <div class="mw-50 text-center">
            ...
            <div class="form-group">
                <div id="showDownloadsContainer" style="display: none;">
                    ...
                    <p><a target="_blank" href="stored/downloads/youtubedl_video/">View downloaded media</a></p>
                </div>
                <div class="d-flex flex-wrap justify-content-center my-3">
                    <a target="_blank" class="mx-3" href="stored/downloads/youtubedl_video/">🌐🎬 Downloaded Videos 🎬🌐</a>
                    <a target="_blank" class="mx-3" href="stored/downloads/youtubedl_audio/">🌐🎵 Downloaded Music 🎵🌐</a>
                </div>
                <div class="d-flex flex-wrap justify-content-between my-3">
                    <a class="" target="_blank" href="stored/movies/">🎥 Movies 🎥</a>
                    <a target="_blank" href="stored/shows/">🎞️ Shows 🎞️</a>
                    <a class="" target="_blank" href="stored/music/">🎵 Music 🎵</a>
                    <a target="_blank" href="stored/flash/">🕹 Flash 🕹</a>
                    <a target="_blank" href="stored/games/">🎮 Games 🎮</a>
                </div>
                <a target="_blank" href="stored/shared/">Shared Files</a>
            </div>
        </div>
    </div>
</main>
